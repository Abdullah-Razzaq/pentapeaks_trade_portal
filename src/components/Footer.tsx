...
export default function Footer() {
  return (
    <footer className="bg-gray-50 text-gray-600 py-12 max-md:py-10 border-t border-gray-200 shadow-sm font-sans">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-12">
          ...
          <div className="flex flex-col lg:col-span-1">
            ...
            <div className="flex flex-wrap gap-4 mt-2">
              <a href="https://www.facebook.com/people/PentaPeaks-International/61589825756983/?mibextid=wwXIfr" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-amber-500 transition-colors max-md:flex max-md:items-center max-md:justify-center max-md:w-10 max-md:h-10 max-md:rounded-full max-md:border max-md:border-gray-200 max-md:bg-white" title="Facebook">
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24"><path d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" /></svg>
              </a>
              <a href="https://www.instagram.com/pentapeaks_intl" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-amber-500 transition-colors max-md:flex max-md:items-center max-md:justify-center max-md:w-10 max-md:h-10 max-md:rounded-full max-md:border max-md:border-gray-200 max-md:bg-white" title="Instagram">
              ...
              <a href="https://www.linkedin.com/company/pentapeaks-international-pvt-ltd/" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-amber-500 transition-colors max-md:flex max-md:items-center max-md:justify-center max-md:w-10 max-md:h-10 max-md:rounded-full max-md:border max-md:border-gray-200 max-md:bg-white" title="LinkedIn">
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z" /></svg>
              </a>
              <a href="https://www.tiktok.com/@pentapeaks_intl" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-amber-500 transition-colors max-md:flex max-md:items-center max-md:justify-center max-md:w-10 max-md:h-10 max-md:rounded-full max-md:border max-md:border-gray-200 max-md:bg-white" title="TikTok">
              ...
              <a href="https://www.youtube.com/@PentaPeaksInternational" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-amber-500 transition-colors max-md:flex max-md:items-center max-md:justify-center max-md:w-10 max-md:h-10 max-md:rounded-full max-md:border max-md:border-gray-200 max-md:bg-white" title="YouTube">
          ...
          {/* Mobile Accordion */}
          <details className="md:hidden group border-b border-gray-200 pb-2">
            <summary className="flex justify-between items-center cursor-pointer list-none text-sm font-semibold text-gray-900 uppercase tracking-wider mb-2">
              Quick Links
            ...
            <ul className="space-y-3 mt-4 text-sm text-gray-600 pb-2">
          ...
          {/* Mobile Card */}
          <div className="md:hidden rounded-xl border border-gray-200 bg-white p-5 mt-4">
            <h3 className="flex items-center gap-2 text-sm font-semibold text-gray-900 uppercase tracking-wider mb-4">
              <span className="ledger-location border-amber-500 text-amber-500 px-2 py-0.5 rounded-sm">
                PK Office
              </span>
            </h3>
            <ul className="space-y-3 text-sm text-gray-600">
        ...
        {/* Bottom Bar */}
        <div className="pt-8 max-md:pt-6 border-t border-gray-200 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-gray-500">
