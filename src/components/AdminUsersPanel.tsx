...
export default function AdminUsersPanel({ currentUserId }: { currentUserId: number }) {
  ...
  return (
    <div className="mx-auto max-w-5xl">
      ...
      <div className="mt-6 overflow-hidden rounded-2xl border border-gray-200 bg-white/50 shadow-sm">
                      ...
                      <div className="flex items-center justify-end gap-2">
                        {user.plan_type !== "pro" && (
                          <button
                            ...
                            className="rounded-lg border border-gray-300 px-2.5 py-1.5 text-xs font-semibold text-gray-600 transition hover:border-purple-500/50 hover:bg-purple-500/10 hover:text-purple-400 disabled:cursor-not-allowed disabled:opacity-50 flex items-center justify-center h-8"
                          >
                        ...
                        <button
                          ...
                          className={`rounded-lg border border-gray-300 px-2.5 py-1.5 text-xs font-semibold text-gray-600 transition disabled:cursor-not-allowed disabled:opacity-50 flex items-center justify-center h-8 ${user.is_active
