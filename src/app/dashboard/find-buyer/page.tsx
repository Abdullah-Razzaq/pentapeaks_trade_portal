    ...
    <div className="flex flex-col mx-auto max-w-7xl min-h-[calc(100vh-200px)]">
      ...
      <div className="bg-[#0a0d12] rounded-3xl p-8 sm:p-12 mb-8 relative overflow-hidden shadow-2xl border border-gray-800">
        ...
        <div className="relative z-10">
          <h1 className="text-3xl sm:text-4xl font-extrabold text-white tracking-tight mb-2">Find Buyer</h1>
          <p className="text-gray-400 max-w-xl leading-relaxed">
            Access our premium database of verified global buyers. Analyze their importing patterns and pinpoint your next high-value customer.
          </p>
        </div>
      </div>
      ...
      <div className="w-full">
        <CompanyExplorer mode="buyer" userRole={session.role} />
      </div>
    </div>
  );
}
